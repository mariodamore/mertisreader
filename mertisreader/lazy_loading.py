# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_lazy_loading.ipynb.

# %% auto #0
__all__ = ['LazyArray', 'LazyCSVLoader']

# %% ../nbs/01_lazy_loading.ipynb #d16bff07
import numpy as np
...
# %% ../nbs/01_lazy_loading.ipynb #b39e80e3
import polars as pl
import pandas as pd
...
class LazyCSVLoader:
    ...
    def columns(self):
        ...
        self._ensure_lazy()
        return self._lazyframe.columns
...
# %% ../nbs/01_lazy_loading.ipynb #b57a3b3d
